...
//         analysis: post.analysis ? {
//           _id: post.analysis._id,
//           toxicityScore: post.analysis.toxicityScore,
//           isBiased: post.analysis.isBiased,
//           isPlagiarized: post.analysis.isPlagiarized,
//           factCheck: post.analysis.factCheck
//         } : null,
//         likes: post.likedBy?.length || 0,
//         userLiked: false, // Optional: depends on current user session
//         commentsCount: post.comments?.length || 0,
//         postedAt: post.postedAt,
//         createdAt: post.createdAt,
//         status: 'active', // Optional: if you want to mock campaign status
//         views: 0 // Optional: if views are tracked
//       };
//     });
